...
public class OutputView {
    ...
    private static final int MATCH_START_NUMBER = 3;        // 당첨개수 3부터 출력
    private static final int MATCH_LAST_NUMBER = 6;         // 당첨개수 6까지 출력
    private static final int[] PRIZE_MONEY = {0, 1000, 2500, 5000, 50000, 1500000, 2000000000}; // 당첨개수별 상금
